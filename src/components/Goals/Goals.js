...
const Goals = props => (
    <div className="GoalsGroup">
        <div className="goal-item create">
            <h2>Create</h2>
            <img src={require('../../images/create_icon_lg.svg')} alt="Create"></img>
        ...
        <div className="goal-item elevate">
            <h2>Elevate</h2>
            <img src={require('../../images/elevate_icon_lg.svg')} alt="Elevate"></img>
        ...
        <div className="goal-item engage">
            <h2>Engage</h2>
            <img src={require('../../images/engage_icon_lg.svg')} alt="Engage"></img>
